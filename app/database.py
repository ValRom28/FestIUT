...
def initdb():
    ...
    concerts = [
        ...
        Concert(id_concert=17, nom_concert='Concert Familiale', tps_prepa_concert=30,
                date_heure_concert=datetime.strptime('2024-01-26 15:00', '%Y-%m-%d %H:%M'), 
                duree_concert=100, id_lieu=3),
